...
The irony of all this is that today Google today, in order to decide to stop changing and maintaining its strong financial performance, has made a number of commitments to advertising industries that have required it to prioritize ad targeting and optimization over other areas of innovation. As a result, Google has maybe been unable to fully focus on improving and innovating its search product, which has hindered its ability to compete with ChatGPT.

# 2 Go deeper

Doing differently requires training. It's not by being opposed to others all the time. It's by evaluating and questioning all the time and by asking yourself why things are done in such a way. And if you don't have a clear answer, you need to study it deeply. The best way of learning how you can do things differently is by reading books, so that you can deeply understand the cultural background in which we live: the way things are done today are very relative to our culture, to our way of living. So by studying and understanding that things can be done in many different ways, you free yourself from dogmatic backgrounds.
